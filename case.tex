...
\begin{figure*}[htb]
\centering
\subfigure[Approval over Dilma Rousseff's campaign. Approval sentiment varied greatly from 05/2010 to 11/2010.]{\includegraphics[width=2.1in,height=1.6in]{dilmaPositividade.pdf}}
\subfigure[MSE numbers as the stream evo\-lves.]{\includegraphics[width=2.1in,height=1.6in]{dilma_1_temporal_mse.pdf}}
\subfigure[X-Y scatter plot correlating the minimum similarity threshold $\alpha$ and labeling effort.]{\includegraphics[width=2.1in,height=1.6in]{dilma_2_similaridade_rotulacoes.pdf}}
\subfigure[X-Y scatter plot correlating labeling effort and MSE numbers.]{\includegraphics[width=2.1in,height=1.6in]{dilma_3_rmse-labelling.pdf}}
\subfigure[Size of the training sets as the stream evolves.]{\includegraphics[width=2.1in,height=1.6in]{dilma_window.pdf}}
\subfigure[RAM-Hours as the stream evo\-lves.]{\includegraphics[width=2.1in,height=1.6in]{dilma_4.pdf}}
