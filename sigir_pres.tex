...
\begin{itemize}
\item Resources limitation: memory, time and labeled examples.
\end{itemize}
\end{itemize}
\end{itemize}
...
%     \item 581,102 examples with 54 features and 7 classes;
...
\item Veloso, A. (2012). \textbf{UFMG respository of machine learning}. https://code.google.com/p/machine-learning-dcc-ufmg/.
\item Other results:
\begin{itemize}
